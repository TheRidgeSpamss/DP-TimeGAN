...
class DP_Discriminator(nn.Module):
    def __init__(self, hidden_dim, num_layers):
        ...
        # Initialize the GRU layer and FC layer, sigmoid activation
        # `self.lstm` class variable is named incorrectly - this should be a GRU and opacus doesn't allow me to change the name
        # without breaking all of my current checkpoints
